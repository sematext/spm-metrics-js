...
CustomMetric.prototype.meter = function () {
  return this.use(this.collection.meter (this.options.name))
}

CustomMetric.prototype.histogram = function () {
  return this.use(this.collection.histogram (this.options.name))
}

CustomMetric.prototype.timer = function () {
  return this.use(this.collection.timer(this.options.name))
}

CustomMetric.prototype.counter = function (initValue) {
  return this.use(this.collection.counter (this.options.name, {count: initValue}))
}
